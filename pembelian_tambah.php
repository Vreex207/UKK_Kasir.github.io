<?php
    if(isset($_POST['id_pelanggan'])) {
        ...
        if($query) {
            echo '<script> alert("Tambah Data Pembelian Berhasil") </script>';
        }else{
            echo '<script> alert("Tambah Data Pembelian Gagal") </script>';
        }
        ...
        <form method="post">
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <td>:</td>
                    <td>
                        <input class="form-control" type="number" step="0" value="0" max="<?php echo $produk['stok']; ?>" name="produk[<?php echo $produk['id_produk']; ?>]">
                    </td>
                </tr>
                    <?php
                    }
